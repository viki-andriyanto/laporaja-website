...
export default function EditForm() {
    ...
    const handleSubmitLaporan = async (e) => {
        ...
        if (result.success) {
            ...
            alert("Terjadi kesalahan saat memperbarui laporan: " + result.error);
        }
    };
    ...
    return (
        <>
                ...
                <div className="container position-relative">
                    <main>
                        <div className="py-5 text-center text-white">
                            <h2 className="mb-4 fw-bold">Edit {reportData?.jenis === 'laporan' ? 'Laporan' : 'Surat'}</h2>
                            <p className="lead mb-4 opacity-90">
                                Perbarui {reportData?.jenis === 'laporan' ? 'laporan' : 'surat'} Anda dengan informasi terbaru.
                            </p>
                        </div>
                        <div
                        ...
                        >
                            {formType === "laporan" ? (
                                <form className="needs-validation" noValidate onSubmit={handleSubmitLaporan}>
                                    <div className="row g-3">
                                        ...
                                        <div className="col-12">
                                            ...
                                            <select 
                                                ...
                                                id="kategori" 
                                                name="kategori" 
                                                defaultValue={reportData?.laporan?.kategori?.kategori_id || ""}
                                                required
                                            >
                                        ...
                                        <div className="col-12">
                                            ...
                                            {reportData?.file_url && (
                                                <small className="text-muted">File saat ini: <a href={reportData.file_url} target="_blank" rel="noopener noreferrer">Lihat</a></small>
                                            )}
                                        </div>
                                ...
                                <form className="needs-validation" noValidate onSubmit={handleSubmitSurat}>
                                    <div className="row g-3">
                                        <div className="col-12">
            ...
            <ModalSukses
                ...
                message={reportData?.jenis === 'laporan' ? "Laporan berhasil diperbarui!" : "Surat berhasil diperbarui!"}
